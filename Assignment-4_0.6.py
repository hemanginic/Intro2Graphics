...
varsion-0.6: step 6 of Cargame, updates in scoring, change fuel tank image and change screen size.
...
class Fuel(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("oil1.png")
        self.rect = self.image.get_rect()
        self.reset()
...
def game():       
    ...
    while keepGoing:
        ...
        if car.rect.colliderect(fuel.rect):
            ...
            fuel.reset()
            scoreboard.score += 10
        # substract lives if car hits the rock
...
def instructions(score):
    ...
    instructions = (
    "Car Game.     Last score: %d" % score ,
    "Instructions:  ",
    "You are driving a car.",
    "",
    "Get the fuel tank for",
    " getting lives,",
    "but be careful not to",
    "crash with rocks",    
    "Your car will crash ",
    "if it is hit by lightning too",
    "many times.",
    "",
    "good luck!",
    "",
